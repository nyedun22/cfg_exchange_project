...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("CREATE TABLE user_details(user_ID INTEGER(10) NOT NULL UNIQUE AUTO_INCREMENT, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL UNIQUE, email VARCHAR(255) NOT NULL UNIQUE, pass_word CHAR(10) NOT NULL, PRIMARY KEY (user_ID))")
        ...
        cursor.execute("CREATE TABLE foreign_account(foreign_account_number INTEGER(8) NOT NULL UNIQUE AUTO_INCREMENT, account_number INTEGER(8) NOT NULL UNIQUE, foreign_account_balance NUMERIC(20,2) NOT NULL, foreign_currency CHAR(3) NOT NULL, PRIMARY KEY (foreign_account_number), FOREIGN KEY (account_number) REFERENCES bank_details(account_number))")
