...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("CREATE TABLE user_details(user_ID INTEGER(10) NOT NULL UNIQUE AUTO_INCREMENT, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, username VARCHAR(20) NOT NULL UNIQUE, email VARCHAR(255) NOT NULL UNIQUE, pass_word VARCHAR(20) NOT NULL, address_line_1 VARCHAR(255) NOT NULL, postcode INTEGER(7), PRIMARY KEY (user_ID))")
