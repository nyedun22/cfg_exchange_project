...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("CREATE TABLE user_details(user_ID INTEGER(10) NOT NULL UNIQUE AUTO_INCREMENT, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL UNIQUE, address_line_1 VARCHAR(255) NOT NULL, postcode INTEGER(7), PRIMARY KEY (user_ID))")
