...
try:
    ...
    if connection.is_connected():
        ...
        cursor.execute("CREATE TABLE user_details(user_ID INTEGER(10) NOT NULL UNIQUE AUTO_INCREMENT, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, username VARCHAR(20) NOT NULL UNIQUE, email VARCHAR(255) NOT NULL UNIQUE, pass_word VARCHAR(20) NOT NULL, address_line_1 VARCHAR(255) NOT NULL, postcode VARCHAR(7), PRIMARY KEY (user_ID))")
        ...
        cursor.execute("CREATE TABLE currency_codes(currency_ID CHAR(3), currency_name VARCHAR(255), country VARCHAR(255), PRIMARY KEY (currency_ID))")
        cursor.execute("CREATE TABLE user_login(login_ID INTEGER(5) NOT NULL UNIQUE AUTO_INCREMENT, username VARCHAR(20) NOT NULL UNIQUE, pass_word VARCHAR(20) NOT NULL, PRIMARY KEY(login_ID))")
